...
> **集合的势**
>
> 如果集合$$A$$为有限集，则集合$$A$$的势为其所含元素的个数，记作$$|A|$$；如果集合$$A$$可以与自然数集$$\mathbb N$$建立双射，它的势记作$$\aleph_0$$。
>
> 两个集合间如果可以建立双射，那么他们的势相同。
>
> 有限集以及可以与自然数集建立双射的集合是可数集
>
> 除此之外的集合被称为不可数集。（感兴趣可以证明：$$\R$$上的闭区间$$[0,1]$$不是可数集）
>
> 
>
> **映射的个数**
...
这样上面的式子出了中间一项之外其他都是常数，而这显然与算法的选取无关。当然注意这是
